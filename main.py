...
#ES_HOST="https://search-cis9760-hyunjik-lee-geqcbpz4anqk3ocd2ajff3zidy.us-east-1.es.amazonaws.com"
...
if args.num_pages:
    print("numpage has set")
else:
    print("Number of page has not set up")
